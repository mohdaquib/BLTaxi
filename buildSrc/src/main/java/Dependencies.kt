object Versions {
    ...
    const val android_x_lifecycle = "2.3.0"
    ...
    const val android_x_databinding_compiler = "4.1.2"

    const val android_x_navigation = "2.3.2"

    const val room = "2.2.5"

    const val firebase_core = "18.0.1"
    ...
    const val crashlytics_gradle_plugin = "2.4.1"
